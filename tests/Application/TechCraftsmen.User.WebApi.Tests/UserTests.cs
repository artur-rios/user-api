...
namespace TechCraftsmen.User.WebApi.Tests
{
    public class UserTests : BaseFunctionalTest, IAsyncLifetime
    {
        ...
        public async void Should_GetUsersByFilter()
        {
            ...
            WebApiOutput<IList<UserDto>>? result = await Get<IList<UserDto>>($"{UserRoute}/Filter{query}");
        ...
        public async void Should_CreateDeactivateAndDeleteUser()
        {
            ...
            WebApiOutput<int>? creationResult = await Post<int>($"{UserRoute}/Create", dto);
            ...
            WebApiOutput<int>? deactivationResult = await Patch<int>($"{UserRoute}/{creationResult.Data}/Deactivate");
            ...
            WebApiOutput<int>? deletionResult = await Delete<int>($"{UserRoute}/{creationResult.Data}/Delete");
        ...
        public async void Should_ReturnValidationError_ForInvalidUserDto()
        {
            ...
            WebApiOutput<int>? result = await Post<int>($"{UserRoute}/Create", dto);
        ...
        {
            WebApiOutput<int>? deactivationResult = await Patch<int>($"{UserRoute}/{UserMockData.TEST_ID}/Deactivate");
            ...
            WebApiOutput<int>? activationResult = await Patch<int>($"{UserRoute}/{UserMockData.TEST_ID}/Activate");
        ...
        public async void Should_UpdateUser()
        {
            ...
            WebApiOutput<UserDto>? updateResult = await Put<UserDto>($"{UserRoute}/Update", userToUpdate);
            ...
            WebApiOutput<IList<UserDto>>? updatedUserResult = await Get<IList<UserDto>>($"{UserRoute}/Filter?Id={userToUpdate.Id}");
            ...
            WebApiOutput<UserDto>? rollbackResult = await Put<UserDto>($"{UserRoute}/Update", _userMocks.TestUserDto);
            ...
            WebApiOutput<IList<UserDto>>? rollbackUserResult = await Get<IList<UserDto>>($"{UserRoute}/Filter?Id={userToUpdate.Id}");
