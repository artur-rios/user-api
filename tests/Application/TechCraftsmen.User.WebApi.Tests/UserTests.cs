...
namespace TechCraftsmen.User.WebApi.Tests
{
    public class UserTests : BaseFunctionalTest, IAsyncLifetime
    {
        ...
        public async void Should_GetUsersByFilter()
        {
            ...
            BaseController.Output<IList<UserDto>>? result = await Get<IList<UserDto>>($"{UserRoute}/Filter{query}");
        ...
        public async void Should_CreateDeactivateAndDeleteUser()
        {
            ...
            BaseController.Output<int>? creationResult = await Post<int>($"{UserRoute}/Create", dto);
            ...
            BaseController.Output<int>? deactivationResult = await Patch<int>($"{UserRoute}/{creationResult.Data}/Deactivate");
            ...
            BaseController.Output<int>? deletionResult = await Delete<int>($"{UserRoute}/{creationResult.Data}/Delete");
        ...
        public async void Should_ReturnValidationError_ForInvalidUserDto()
        {
            ...
            BaseController.Output<int>? result = await Post<int>($"{UserRoute}/Create", dto);
        ...
        {
            BaseController.Output<int>? deactivationResult = await Patch<int>($"{UserRoute}/{UserMockData.TEST_ID}/Deactivate");
            ...
            BaseController.Output<int>? activationResult = await Patch<int>($"{UserRoute}/{UserMockData.TEST_ID}/Activate");
        ...
        public async void Should_UpdateUser()
        {
            ...
            BaseController.Output<UserDto>? updateResult = await Put<UserDto>($"{UserRoute}/Update", userToUpdate);
            ...
            BaseController.Output<IList<UserDto>>? updatedUserResult = await Get<IList<UserDto>>($"{UserRoute}/Filter?Id={userToUpdate.Id}");
            ...
            BaseController.Output<UserDto>? rollbackResult = await Put<UserDto>($"{UserRoute}/Update", _userMocks.TestUserDto);
            ...
            BaseController.Output<IList<UserDto>>? rollbackUserResult = await Get<IList<UserDto>>($"{UserRoute}/Filter?Id={userToUpdate.Id}");
